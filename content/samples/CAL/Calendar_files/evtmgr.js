...
var URL_RETRIEVE_EVENT;			//set to the value for your back end system
						//e.g., "/cal?pAction=eventRetrieve&eventID="
...
function getCalendarEventRecord(evt){
	...
	//TODO This is where you tie into your own back-end if present
	if(!URL_RETRIEVE_EVENT) return evt;
	var url =  URL_RETRIEVE_EVENT + eventID;
